...
public class DBToText {
	...
	public static void main(String[] args) {
		...
		//EMPRESATable empresaTable = new EMPRESATable(new Connector());
		//ESTABTable estabTable = new ESTABTable(new Connector());
		...
		//OUTRAEMPRESATable outraempresaTable = new OUTRAEMPRESATable(new Connector());
		...
		//EVENTOVARIAVELTable eventovariavelTable = new EVENTOVARIAVELTable(new Connector());
		EVENTOVARIAVELPIPETable eventovariavelpipeTable = new EVENTOVARIAVELPIPETable(new Connector());
		//EVENTOFIXO2Table eventofixo2Table = new EVENTOFIXO2Table(new Connector());
		//TIPOPLANOSAUDETable tipoplanosaudeTable = new TIPOPLANOSAUDETable(new Connector());
		...
		//FUNCESCALAVALETRANSPTable funcescalavaletranspTable = new FUNCESCALAVALETRANSPTable(new Connector());
		...
		//FileCreator.CreateFile("Empresa", empresaTable.tableToText());
		//FileCreator.CreateFile("Estab", estabTable.tableToText());
		//FileCreator.CreateFile("FuncPessoa", epgTable.tableToText());
		//FileCreator.CreateFile("Dependente", depTable.tableToText());
		//FileCreator.CreateFile("Dependente_2PAI", depmaepaiTable.tableToText());
		...
		//FileCreator.CreateFile("OutraEmpresa", outraempresaTable.tableToText());
		...
		//FileCreator.CreateFile("EventoVariavel", eventovariavelTable.tableToText());
		FileCreator.CreateFile("EventoVariavel_PIPE", eventovariavelpipeTable.tableToText());
		//FileCreator.CreateFile("EventoFixo", eventofixoTable.tableToText());
		//FileCreator.CreateFile("EventoFixo2", eventofixo2Table.tableToText());
		//FileCreator.CreateFile("TipoPlanoSaude", tipoplanosaudeTable.tableToText());
		...
		//FileCreator.CreateFile("FuncescalaValeTransp", funcescalavaletranspTable.tableToText());
