	...
	public RESCISAOTable(Connector con) {
		...
		try {
			while(rs.next()) {
				...
				dbl.getFields().add(new StringField(4, ""));
				dbl.getFields().add(new StringField(4, ""));
				dbl.getFields().add(new NumberField(16, rs.getInt("MAIORREMUNERACAO")));
				dbl.getFields().add(new StringField(2, "1"));
				dbl.getFields().add(new NumberField(16, rs.getInt("SALDOCEF")));
				dbl.getFields().add(new StringField(255, ""));
				dbl.getFields().add(new StringField(16, "0,00"));
				dbl.getFields().add(new StringField(16, "0,00"));
				dbl.getFields().add(new StringField(16, "0,00"));
				dbl.getFields().add(new StringField(16, "0,00"));
				dbl.getFields().add(new StringField(16, "0,00"));
