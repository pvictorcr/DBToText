...
public class EVENTOVARIAVELTable extends GenericTable {
	...
	private final String tableName = "fol\r\n"
			...
			+ "where fol.emp_codigo = '0008' and epg_codigo = '003162' and dtcalculo = '30.09.2020 00:00'\r\n"
			+ "and eve_codigo not in(011, 310, 091, 600, 601, 602, 603, 604, 605) order by dtcalculo";
	
	public EVENTOVARIAVELTable(Connector con) {
		...
		if(empregadoAnterior == empregadoAtual) {
			...
			ID = 1;
				...
				dbl.getFields().add(new NumberField(7, rs.getInt("EFO_EPG_CODIGO")));
				dbl.getFields().add(new StringField(11, rs.getString("EVE_CODIGO")));
				dbl.getFields().add(new StringField(18, rs.getString("PARAMETRO"))); //Refer�ncia do Evento
